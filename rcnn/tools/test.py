...
def test_net(prefix, iter_no, exp_folder):
    logger.info('Testing ...')
    ...
    prop_file = os.path.join(exp_folder,'proposals_%s_%s.mat' % (default.test_image_set, default.exp_name))
...
if __name__ == '__main__':
    ...
    default.e2e_prefix = os.path.join(exec_args.exp_folder,'model') + '/'+default.exp_name
